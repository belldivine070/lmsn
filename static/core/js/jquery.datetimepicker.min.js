  ...
  var a = {
    ...
    s = function () {
      ...
      "function" == typeof DateFormatter &&
        (o = r = new DateFormatter({ dateSettings: e.extend({}, i, s) }));
    },
    d = {
      moment: {
        default_options: {
        ...
        "hide" !== a
          ? (e(this).hasClass("xdsoft_scroller_box") ||
                  ...
                  function (o) {
                    r || d.trigger("resize_scroll.xdsoft_scroller", [a]),
                      ...
                      "mousedown" === o.type || "touchstart" === o.type
                        ...
                        : ((g = !0), o.stopPropagation(), o.preventDefault());
                  }
                )
                ...
                .on("scroll_element.xdsoft_scroller", function (e, t) {
                  r || d.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                    ...
                    setTimeout(function () {
                      o.css(
                        "marginTop",
                        -parseInt((o[0].offsetHeight - r) * t, 10)
                      );
                    }, 10);
                })
              ...
              d.on("mousewheel", function (e) {
                ...
                return (
                  (t -= 20 * e.deltaY) < 0 && (t = 0),
                  d.trigger("scroll_element.xdsoft_scroller", [t / (n - r)]),
                  e.stopPropagation(),
                  !1
                );
              }),
      ...
      return (
        (s = function (a) {
          function i() {
            ...
            return (
              C.startDate
                ...
                : C.defaultDate &&
                  ((t = Y.strToDateTime(C.defaultDate)),
                  C.defaultTime &&
                    ((e = Y.strtotime(C.defaultTime)),
                    t.setHours(e.getHours()),
                    t.setMinutes(e.getMinutes()))),
              t && Y.isValidDate(t) ? H.data("changed", !0) : (t = ""),
              t || 0
            );
          }
          function s(t) {
            ...
            t.mask && a.off("keydown.xdsoft"),
              ...
              "string" === e.type(t.mask) &&
                (r(t.mask, a.val()) ||
                  (a.val(t.mask.replace(/[0-9]/g, "_")), n(a[0], 0)),
                a.on("paste.xdsoft", function (o) {
                  var i = (
                      o.clipboardData ||
                  ...
                  if (
                    ...
                    for (
                      i =
                        d === y || d === g
                          ? "_"
                          : String.fromCharCode(c <= d && d <= m ? d - l : d),
                        d === y && u && !P && (u -= 1);
                      ;
          ...
          C.id && H.attr("id", C.id),
            ...
            N.find(".xdsoft_month span").after(B),
            N.find(".xdsoft_year span").after(G),
              ...
              function (t) {
                ...
                for (
                  N.find(".xdsoft_select").hide(),
                    ...
                    o = 0;
                  o < a.length && a.eq(o).data("value") !== n;
                  o += 1
                )
                  i += a[0].offsetHeight;
                return (
          ...
          var U = function (e) {
            ...
            Math.sqrt(o * o + r * r) > C.touchMovedThreshold &&
              (this.touchMoved = !0);
          };
          N.find(".xdsoft_select")
            ...
            .on("touchmove", ".xdsoft_option", U)
            .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
              if (!this.touchMoved) {
                (void 0 !== Y.currentTime && null !== Y.currentTime) ||
                  (Y.currentTime = Y.now());
                ...
                Y &&
                  ...
                  C.onChangeMonth &&
                    ...
                    C.onChangeMonth.call(H, Y.currentTime, H.data("input")),
                  t !== Y.currentTime.getFullYear() &&
                    e.isFunction(C.onChangeYear) &&
                    C.onChangeYear.call(H, Y.currentTime, H.data("input"));
              }
            }),
            (H.getValue = function () {
            ...
            (H.setOptions = function (r) {
              ...
              (C = e.extend(!0, {}, C, r)),
                r.allowTimes &&
                  ...
                  r.allowTimes.length &&
                  (C.allowTimes = e.extend(!0, [], r.allowTimes)),
                r.weekends &&
                  e.isArray(r.weekends) &&
                  r.weekends.length &&
                  (C.weekends = e.extend(!0, [], r.weekends)),
                r.allowDates &&
                  e.isArray(r.allowDates) &&
                  r.allowDates.length &&
                  (C.allowDates = e.extend(!0, [], r.allowDates)),
                r.allowDateRe &&
                  "[object String]" ===
                    Object.prototype.toString.call(r.allowDateRe) &&
                  (C.allowDateRe = new RegExp(r.allowDateRe)),
                r.highlightedDates &&
                ...
                r.highlightedPeriods &&
                  ...
                  e.each(r.highlightedPeriods, function (a, r) {
                    ...
                    if (e.isArray(r))
                      ...
                      (i = o.parseDate(m[0], C.formatDate)),
                        (s = o.parseDate(m[1], C.formatDate)),
                        (d = m[2]),
                        (c = m[3]);
                    }
                    for (; i <= s; )
                      (u = new t(i, d, c)),
                        (l = o.formatDate(i, C.formatDate)),
                ...
                r.disabledDates &&
                  ...
                  (C.disabledDates = e.extend(!0, [], r.disabledDates)),
                r.disabledWeekDays &&
                  e.isArray(r.disabledWeekDays) &&
                  r.disabledWeekDays.length &&
                  (C.disabledWeekDays = e.extend(!0, [], r.disabledWeekDays)),
                (!C.open && !C.opened) || C.inline || a.trigger("open.xdsoft"),
                C.inline &&
                  ((q = !0), H.addClass("xdsoft_inline"), a.after(H).hide()),
                C.inverseButton &&
                ...
                C.value &&
                  (Y.setCurrentTime(C.value), a && a.val && a.val(Y.str)),
                ...
                C.minDate &&
                  /^[\+\-](.*)$/.test(C.minDate) &&
                  (C.minDate = o.formatDate(
                    Y.strToDateTime(C.minDate),
                    C.formatDate
                  )),
                C.maxDate &&
                  /^[\+\-](.*)$/.test(C.maxDate) &&
                  (C.maxDate = o.formatDate(
                    Y.strToDateTime(C.maxDate),
                    C.formatDate
                  )),
                C.minDateTime &&
                  /^\+(.*)$/.test(C.minDateTime) &&
                  (C.minDateTime = Y.strToDateTime(C.minDateTime).dateFormat(
                    C.formatDate
                  )),
                C.maxDateTime &&
                  /^\+(.*)$/.test(C.maxDateTime) &&
                  (C.maxDateTime = Y.strToDateTime(C.maxDateTime).dateFormat(
                    C.formatDate
                  )),
                R.toggle(C.showApplyButton),
                ...
                C.validateOnBlur &&
                  a.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      e(this).val(null), H.data("xdsoft_datetime").empty();
                    else {
                      var t = o.parseDate(e(this).val(), C.format);
                      if (t) e(this).val(o.formatDate(t, C.format));
                      else {
                        ...
                        r < 60
                          ...
                          : e(this).val(o.formatDate(Y.now(), C.format));
                      }
            ...
            (Y = new (function () {
              ...
              (t.now = function (e) {
                ...
                return (
                  ...
                  !e &&
                    C.defaultTime &&
                    ((o = t.strtotime(C.defaultTime)),
                    r.setHours(o.getHours()),
                    r.setMinutes(o.getMinutes()),
                    r.setSeconds(o.getSeconds()),
                    r.setMilliseconds(o.getMilliseconds())),
                  r
                );
              }),
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((n = /^([+-]{1})(.*)$/.exec(e)) &&
                        (n[2] = o.parseDate(n[2], C.formatDate)),
                      n && n[2]
                        ? ((a =
                            n[2].getTime() - 6e4 * n[2].getTimezoneOffset()),
                          (r = new Date(
                            t.now(!0).getTime() + parseInt(n[1] + "1", 10) * a
                          )))
                        : (r = e ? o.parseDate(e, C.format) : t.now()),
            ...
            N.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function e(r) {
                  t.hasClass(C.next)
                    ? Y.nextMonth()
                    : t.hasClass(C.prev) && Y.prevMonth(),
                    C.monthChangeSpinner &&
                      (o || (a = setTimeout(e, r || 100)));
                })(500),
                ...
                !(function e(n) {
                  ...
                  t.hasClass(C.next) && s - i - C.timeHeightInTimePicker >= d
                    ...
                    E.trigger("scroll_element.xdsoft_scroller", [
                      Math.abs(parseInt(V[0].style.marginTop, 10) / (s - i)),
                    ]),
                    (r = r > 10 ? 10 : r - 10),
                    o || (a = setTimeout(e, n || r));
                })(500),
                  e([C.ownerDocument.body, C.contentWindow]).on(
                    "touchend mouseup.xdsoft",
                    function t() {
            ...
            H.on("xchange.xdsoft", function (t) {
              clearTimeout(d),
                (d = setTimeout(function () {
                  ...
                  for (
                    !1 !== b &&
                    (M =
                      31 * (12 * b.getFullYear() + b.getMonth()) + b.getDate());
                    D < Y.currentTime.countDaysInMonth() ||
                    p.getDay() !== C.dayOfWeekStart ||
                    Y.currentTime.getMonth() === p.getMonth();
                    ...
                    (T = []),
                      ...
                      (c =
                        C.beforeShowDay && e.isFunction(C.beforeShowDay.call)
                          ? C.beforeShowDay.call(H, p)
                          : null),
                      C.allowDateRe &&
                        "[object RegExp]" ===
                          Object.prototype.toString.call(C.allowDateRe) &&
                        (C.allowDateRe.test(o.formatDate(p, C.formatDate)) ||
                          T.push("xdsoft_disabled")),
                      C.allowDates &&
                        C.allowDates.length > 0 &&
                        -1 ===
                          C.allowDates.indexOf(o.formatDate(p, C.formatDate)) &&
                        T.push("xdsoft_disabled");
                    var w =
                    ...
                    ((!1 !== k && p > k) ||
                      ...
                      -1 !==
                        C.disabledDates.indexOf(
                          o.formatDate(p, C.formatDate)
                        ) && T.push("xdsoft_disabled"),
                      -1 !== C.disabledWeekDays.indexOf(s) &&
                        T.push("xdsoft_disabled"),
                      a.is("[disabled]") && T.push("xdsoft_disabled"),
                      c && "" !== c[1] && T.push(c[1]),
                      Y.currentTime.getMonth() !== l &&
                        T.push("xdsoft_other_month"),
                      (C.defaultSelect || H.data("changed")) &&
                        o.formatDate(Y.currentTime, C.formatDate) ===
                          o.formatDate(p, C.formatDate) &&
                        T.push("xdsoft_current"),
                      o.formatDate(y, C.formatDate) ===
                        o.formatDate(p, C.formatDate) && T.push("xdsoft_today"),
                      (0 !== p.getDay() &&
                        6 !== p.getDay() &&
                        -1 ===
                          C.weekends.indexOf(o.formatDate(p, C.formatDate))) ||
                        T.push("xdsoft_weekend"),
                      void 0 !==
                        C.highlightedDates[o.formatDate(p, C.formatDate)] &&
                        ((i =
                          C.highlightedDates[o.formatDate(p, C.formatDate)]),
                        T.push(
                          void 0 === i.style
                  ...
                  (g += "</tbody></table>"),
                    ...
                    N.find(".xdsoft_label span")
                      .eq(0)
                      .text(C.i18n[n].months[Y.currentTime.getMonth()]),
                    N.find(".xdsoft_label span")
                      .eq(1)
                      .text(Y.currentTime.getFullYear() + C.yearOffset),
                    (O = ""),
                    (l = "");
                  var W = 0;
                  if (!1 !== C.minTime) {
                  ...
                  if (
                    ((m = function (t, r) {
                      ...
                      i.setHours(t),
                        ...
                        (T = []);
                      var d = 60 * t + r;
                      (a.is("[disabled]") || d >= _ || d < W) &&
                        T.push("xdsoft_disabled"),
                        (n = new Date(Y.currentTime)).setHours(
                          parseInt(Y.currentTime.getHours(), 10)
                        ),
                        s ||
                          n.setMinutes(
                            Math[C.roundTime](
                              Y.currentTime.getMinutes() / C.step
                            ) * C.step
                          ),
                        (C.initTime || C.defaultSelect || H.data("changed")) &&
                          n.getHours() === parseInt(t, 10) &&
                          ((!s && C.step > 59) ||
                            n.getMinutes() === parseInt(r, 10)) &&
                          (C.defaultSelect || H.data("changed")
                            ? T.push("xdsoft_current")
                            : C.initTime && T.push("xdsoft_init_time")),
                        parseInt(y.getHours(), 10) === parseInt(t, 10) &&
                    ...
                    for (D = 0; D < C.allowTimes.length; D += 1)
                      m(
                        Y.strtotime(C.allowTimes[D]).getHours(),
                        (l = Y.strtotime(C.allowTimes[D]).getMinutes())
                      );
                  else
                  ...
                  for (
                    V.html(O), r = "", D = parseInt(C.yearStart, 10);
                    D <= parseInt(C.yearEnd, 10);
                    D += 1
                  )
                    r +=
                      '<div class="xdsoft_option ' +
                      (Y.currentTime.getFullYear() === D
                        ? "xdsoft_current"
                        : "") +
                      '" data-value="' +
                      D +
                  ...
                  for (
                    ...
                    r +=
                      '<div class="xdsoft_option ' +
                      (Y.currentTime.getMonth() === D ? "xdsoft_current" : "") +
                      '" data-value="' +
                      D +
                      '">' +
                      C.i18n[n].months[D] +
              ...
              if (C.timepicker) {
                var e, t, a, o;
                V.find(".xdsoft_current").length
                  ? (e = ".xdsoft_current")
                  : V.find(".xdsoft_init_time").length &&
                    (e = ".xdsoft_init_time"),
                  e
                    ? ((t = E[0].clientHeight),
                      (a = V[0].offsetHeight) - t <
                        (o =
                          V.find(e).index() * C.timeHeightInTimePicker + 1) &&
                        (o = a - t),
                      E.trigger("scroll_element.xdsoft_scroller", [
                        parseInt(o, 10) / (a - t),
                      ]))
            ...
            (u = 0),
            I.on("touchend click.xdsoft", "td", function (t) {
              t.stopPropagation(), (u += 1);
              var o = e(this),
                r = Y.currentTime;
              if (
                ((void 0 !== r && null !== r) ||
                  ((Y.currentTime = Y.now()), (r = Y.currentTime)),
                o.hasClass("xdsoft_disabled"))
              )
                return !1;
              r.setDate(1),
                r.setFullYear(o.data("year")),
                r.setMonth(o.data("month")),
                r.setDate(o.data("date")),
                H.trigger("select.xdsoft", [r]),
                a.val(Y.str()),
                C.onSelectDate &&
                  e.isFunction(C.onSelectDate) &&
                  C.onSelectDate.call(H, Y.currentTime, H.data("input"), t),
                H.data("changed", !0),
                H.trigger("xchange.xdsoft"),
                H.trigger("changedatetime.xdsoft"),
                (u > 1 ||
            ...
            V.on("touchstart", "div", function (e) {
              ...
              .on("touchend click.xdsoft", "div", function (t) {
                if (!this.touchMoved) {
                  ...
                  if (
                    ((void 0 !== o && null !== o) ||
                      ((Y.currentTime = Y.now()), (o = Y.currentTime)),
                    a.hasClass("xdsoft_disabled"))
                  )
                    return !1;
                  o.setHours(a.data("hour")),
                    o.setMinutes(a.data("minute")),
                    H.trigger("select.xdsoft", [o]),
                    H.data("input").val(Y.str()),
                    C.onSelectTime &&
                      e.isFunction(C.onSelectTime) &&
                      C.onSelectTime.call(H, Y.currentTime, H.data("input"), t),
                    H.data("changed", !0),
                    H.trigger("xchange.xdsoft"),
                    H.trigger("changedatetime.xdsoft"),
                    !0 !== C.inline &&
            ...
            z.on("mousewheel.xdsoft", function (e) {
              return (
                !C.scrollMonth ||
                (e.deltaY < 0 ? Y.nextMonth() : Y.prevMonth(), !1)
              );
            }),
            a.on("mousewheel.xdsoft", function (e) {
              return (
                ...
                (!C.datepicker && C.timepicker
                  ? ((P = V.find(".xdsoft_current").length
                      ? V.find(".xdsoft_current").eq(0).index()
                      : 0) +
                      e.deltaY >=
                      0 &&
                      P + e.deltaY < V.children().length &&
                      (P += e.deltaY),
                    V.children().eq(P).length &&
                      V.children().eq(P).trigger("mousedown"),
                    !1)
                  : C.datepicker && !C.timepicker
            ...
            H.on("changedatetime.xdsoft", function (t) {
              if (C.onChangeDateTime && e.isFunction(C.onChangeDateTime)) {
                var a = H.data("input");
                C.onChangeDateTime.call(H, Y.currentTime, a, t),
                  delete C.value,
                  a.trigger("change");
              }
            })
              .on("generate.xdsoft", function () {
                C.onGenerate &&
                  ...
                  C.onGenerate.call(H, Y.currentTime, H.data("input")),
                  q && (H.trigger("afterOpen.xdsoft"), (q = !1));
              })
            ...
            (A = function () {
              ...
              if (
                ...
                (a = d[0]),
                (l = "top"),
                (o = t.top + a.offsetHeight - 1),
                (r = t.left),
                (n = "absolute"),
                (u = e(C.contentWindow).width()),
              ...
              "rtl" === d.parent().css("direction") &&
                (r -= H.outerWidth() - d.outerWidth()),
                C.fixed
                  ? ((o -= m),
                    (r -= e(C.contentWindow).scrollLeft()),
                    (n = "fixed"))
                  : ((s = !1),
                    j(a, function (e) {
                      return (
                    ...
                    s
                      ? ((n = "fixed"),
                        o + H.outerHeight() > c + m
                          ? ((l = "bottom"), (o = c + m - t.top))
                          : (o -= m))
                      : o + H[0].offsetHeight > c + m &&
                        (o = t.top - H[0].offsetHeight + 1),
                    o < 0 && (o = 0),
                ...
                ((f = { position: n, left: r, top: "", bottom: "" })[l] = o),
                H.css(f);
            }),
            H.on("open.xdsoft", function (t) {
              ...
              C.onShow &&
                ...
                (a = C.onShow.call(H, Y.currentTime, H.data("input"), t)),
                !1 !== a &&
                  (H.show(),
                  A(),
                  e(C.contentWindow)
              ...
              .on("close.xdsoft", function (t) {
                ...
                N.find(".xdsoft_month,.xdsoft_year")
                  ...
                  C.onClose &&
                    ...
                    (a = C.onClose.call(H, Y.currentTime, H.data("input"), t)),
                  !1 === a || C.opened || C.inline || H.hide(),
                  t.stopPropagation();
              })
              .on("toggle.xdsoft", function () {
                H.is(":visible")
                  ? H.trigger("close.xdsoft")
                  : H.trigger("open.xdsoft");
              })
              .data("input", a),
            (K = 0),
            ...
            a
              ...
              .on("keydown.xdsoft", function (t) {
                var a,
                  o = t.which;
                return -1 !== [p].indexOf(o) && C.enterLikeTab
                  ? ((a = e(
                  ...
                  (this.value = this.defaultValue),
                    (this.value &&
                      t
                        ...
                        .isValidDate(o.parseDate(this.value, C.format))) ||
                      t.data("changed", !1),
